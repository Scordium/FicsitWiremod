...
public:
	...
	{
		return UReflectionUtilities::GetString(Object, SourceName, FromProperty, Meta) == Value;
	}
...
public:
	...
	virtual bool Equals(UObject* Object, FName SourceName, bool FromProperty, FConnectionMeta& Meta) override
	{
		return UReflectionUtilities::GetStringArray(Object, SourceName, FromProperty, Meta) == Value;
	}
