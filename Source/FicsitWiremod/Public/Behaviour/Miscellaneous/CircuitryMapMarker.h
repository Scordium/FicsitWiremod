...
public:
	...
	virtual FPlayerInfoHandle GetLastEditedBy() const override { return LastEditedBy; }
	virtual void SetActorLastEditedByHandle(const FPlayerInfoHandle& Handle) override { this->LastEditedBy = Handle; }
